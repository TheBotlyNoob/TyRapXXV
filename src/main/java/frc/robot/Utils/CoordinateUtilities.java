...
public class CoordinateUtilities {
  ...
  /**
   * Returns a WPILib transform representation of a position offset expressed in range and angle
   * using the FRC coordinate system
   *
  ...
  /**
   * Returns the bearing angle in degrees between two positions. The rotation elements of the poses
   * are not considered
   *
  ...
  /**
   * Converts a course and speed to its x and y components. The returned value will have zero
   * angular velocity
   *
