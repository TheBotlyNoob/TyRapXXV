...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public ClimberSubsystem(
      AbsoluteEncoder climbArmEncoder, NetworkTableInstance nt, SafeableSubsystem[] toMakeSafe) {
    ...
    m_clampPneumatic =
        new DoubleSolenoid(
            ...
            Constants.Climber.kClampSolenoidCANID1,
            Constants.Climber.kClampSolenoidCANID2);
    m_lowerPneumatic =
        new DoubleSolenoid(
            PneumaticsModuleType.CTREPCM,
            Constants.Climber.kLowerSolenoidCANID1,
            Constants.Climber.kLowerSolenoidCANID2);
    m_rampPneumatic =
        new DoubleSolenoid(
            PneumaticsModuleType.CTREPCM,
            Constants.Climber.kRampSolenoidCANID1,
