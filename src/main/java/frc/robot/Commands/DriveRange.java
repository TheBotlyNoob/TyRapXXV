...
// This Command uses DriveDistance Command and the range sensor to drive until the range is a
// certain value or has gone too far
public class DriveRange extends DriveDistance {
  ...
  public DriveRange(
      Drivetrain dt,
      DoubleSupplier maxDistanceSupplier,
