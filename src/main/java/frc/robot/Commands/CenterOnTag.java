...
public class CenterOnTag extends Command {
  ...
  private static GenericEntry minXVelEntry =
      Shuffleboard.getTab("Limelight")
          .add("minXVelEntry", LimelightConstants.minXVelocity)
          .getEntry();
  private static GenericEntry maxXVelEntry =
      Shuffleboard.getTab("Limelight")
          .add("maxXVelEntry", LimelightConstants.maxXVelocity)
          .getEntry();
  private static GenericEntry minYVelEntry =
      Shuffleboard.getTab("Limelight")
          .add("minYVelEntry", LimelightConstants.minYVelocity)
          .getEntry();
  private static GenericEntry maxYVelEntry =
      Shuffleboard.getTab("Limelight")
          .add("maxYVelEntry", LimelightConstants.maxYVelocity)
          .getEntry();
  private static GenericEntry minAngVelEntry =
      Shuffleboard.getTab("Limelight")
          .add("minAngVelEntry", LimelightConstants.minAngVelocityDPS)
          .getEntry();
  private static GenericEntry maxAngVelEntry =
      Shuffleboard.getTab("Limelight")
          .add("maxAngVelEntry", LimelightConstants.maxAngVelocityDPS)
          .getEntry();
  private static GenericEntry xOffsetEntry =
      Shuffleboard.getTab("Limelight").add("xOffsetEntry", LimelightConstants.xOffset).getEntry();
  private static GenericEntry yOffsetEntry =
      Shuffleboard.getTab("Limelight").add("yOffsetEntry", LimelightConstants.yOffset).getEntry();
  private static GenericEntry maxAccEntry =
      Shuffleboard.getTab("Limelight").add("maxAccEntry", LimelightConstants.maxAccMSS).getEntry();
  private static GenericEntry maxDccEntry =
      Shuffleboard.getTab("Limelight").add("maxDccEntry", LimelightConstants.maxDccMSS).getEntry();
  private static GenericEntry maxAngAccEntry =
      Shuffleboard.getTab("Limelight")
          .add("maxAngAccEntry", LimelightConstants.maxAngAccMSS)
          .getEntry();
  private static GenericEntry maxAngDccEntry =
      Shuffleboard.getTab("Limelight")
          .add("maxAngDccEntry", LimelightConstants.maxAngDccMSS)
          .getEntry();
  ...
  public void execute() {
    ...
    if (ll.getTimeSinceValid() == 0) {
      ...
      //     desiredAngVel = 0;
      // } else {
      //     desiredAngVel = Math.copySign(MathUtil.clamp(calculatedAngVel, minAngVel, maxAngVel),
      // rotAngleDegrees);
      // }
