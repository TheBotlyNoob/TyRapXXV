...
public class CoordinateTest {
    ...
    void coordinateTest() {
        ...
        Pose2d desiredEndPoseFieldRelative = currentRobotPose.plus(new Transform2d(
            desiredEndPoseRobotRelative.getX(), desiredEndPoseRobotRelative.getY(), new Rotation2d()));
